...
contract MockOperator is AuthorizedReceiver, ConfirmedOwner, LinkTokenReceiver, OperatorInterface, WithdrawalInterface {
  ...
  function operatorRequest(
    ...
    commitments[requestId] = Request(sender, callbackFunctionId);
    ...
    returns (bool)
  {
    ...
    (bool success, ) = req.callbackAddr.call(abi.encodeWithSelector(req.callbackFunctionId, requestId, data)); // solhint-disable-line avoid-low-level-calls
    return success;
  }
